	...
	implements ActionListener
{
	...
	public PlayersFrame()
	{
		...
		final JLabel label1 = new JLabel( "Jogador 1: " );
		contentPane.add( label1 );
		contentPane.add( this.mTextField1 );

		final JLabel label2 = new JLabel( "Jogador 2: " );
		contentPane.add( label2 );
		contentPane.add( this.mTextField2 );

		final JLabel label3 = new JLabel( "Jogador 3: " );
		contentPane.add( label3 );
		contentPane.add( this.mTextField3 );

		final JLabel label4 = new JLabel( "Jogador 4: " );
		contentPane.add( label4 );
		contentPane.add( this.mTextField4 );

		final JLabel label5 = new JLabel( "Jogador 5: " );
		contentPane.add( label5 );
		contentPane.add( this.mTextField5 );

		final JLabel label6 = new JLabel( "Jogador 6: " );
		...
		this.mColorList.add( Color.PINK );
		this.mColorList.add( Color.gray );
		this.mColorList.add( Color.magenta );
	...
	public void actionPerformed( final ActionEvent arg0 )
	{
		...
		{
			JOptionPane.showMessageDialog( this, "Sao necessarios no minimo 2 jogadores,\n"
